                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0 text-center">
                                    <h1 style="width: 100%">LOCOMOTIVA</h1>
<!--                                            <img src="../../../assets/images/logo/logo.svg" alt="branding logo" width="200">-->
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" action="/login/autenticar" novalidate>
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                <input type="text" class="form-control" name="usuario" placeholder="Digite o Usuário" required>
...
<!--                                                    </fieldset>-->
<!--                                                </div>-->
<!--                                                <div class="col-sm-6 col-12 text-center text-sm-right"><a href="/login/recuperar_senha" class="card-link">Esqueceu a senha?</a></div>-->
<!--                                            </div>-->
                                            <button type="submit" class="btn btn-danger btn-block"><i class="ft-unlock"></i> ACESSAR</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="">
                                        <p class="text-center m-0">Locomotiva</p>
                                    </div>
                                </div>
                            </div>
                        </div>
